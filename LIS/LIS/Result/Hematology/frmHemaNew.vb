...
Public Class frmHemaNew
    ...
    Private Sub btnPreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPreview.Click
        ...
        frmHemaPrevious.Sex = cboSex.Text
    ...
    Private Sub _riEditor_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles _riEditor.EditValueChanged
        GridView.FocusedColumn = GridView.Columns("Result")
        GridView.ShowEditor()
        ...
        For x As Integer = 0 To Me.GridView.RowCount - 1 Step 1
            If GridView.GetRowCellValue(x, GridView.Columns("TestCode")).ToString = "BType" Then
...
#Region "HIS Integration Methods"
    ...
    Public Function getHIS_Test(ByVal accesion_no As String, or_no As String, ByVal cs_no As String)
        ...
        Connect()
        rs.Connection = conn
        rs.CommandText = "Select id FROM additional_info WHERE accession_no = @accession_no And or_no = @or_no And cs_no = @ChargeSlip And section = @section And sub_section = @sub_section ORDER BY additional_info.sample_id"
        reader = rs.ExecuteReader
        If reader.HasRows Then
            While reader.Read
                test_string = ""

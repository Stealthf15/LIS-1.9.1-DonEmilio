...
Public Class frmImmunoAddTest
    ...
    Public Sub LoadRecords()
        Try
            ...
            Connect()
            rs.Connection = conn
            rs.CommandText = "SELECT * FROM `default_specimen` WHERE `Section` = 'Urinalysis' AND `status` = 'Enable' ORDER BY `order_no`"

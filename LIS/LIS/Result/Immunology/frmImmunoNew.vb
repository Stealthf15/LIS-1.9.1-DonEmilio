...
Public Class frmImmunoNew
    ...
    Private Sub btnAddTest_ItemClick(ByVal sender As Object, ByVal e As EventArgs) Handles btnAddTest.Click
        ...
        frmImmunoAddTest.TypeResult = "New"
        frmImmunoAddTest.SubSection = SubSection
        frmImmunoAddTest.Section = "Immunology"

...
Public Class frmUrinNew
    ...
    Private Sub btnPreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPreview.Click
        ...
        frmUrinPrevious.Age = txtAge.Text
        frmUrinPrevious.Sex = cboSex.Text
        frmUrinPrevious.Classification = txtClass.Text
    ...
    Private Sub frmHemaNew_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.cboPathologist.Text = Pathologist
    End Sub

    Private Sub frmHemaNew_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        AutoLoadDoctor()
        AutoLoadRoom()
        AutoLoadVerificator()
    End Sub

    Private Sub frmHemaNew_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        LoadTest()
    End Sub
    ...
    Private Sub btnAddTest_ItemClick(ByVal sender As Object, ByVal e As EventArgs) Handles btnAddTest.Click
        frmUrinAddTest.mainID = mainID
        frmUrinAddTest.patientID = txtPatientID.Text
        frmUrinAddTest.TypeResult = "New"
        frmUrinAddTest.SubSection = SubSection
        frmUrinAddTest.Section = "Urinalysis"
        frmUrinAddTest.ShowDialog()
    End Sub
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        frmUrinPatientList.Type = "New"
        frmUrinPatientList.ShowDialog()
    End Sub
...
#Region "Procedure for Release"
    ...
    Public Sub PrintReleaseResult()
        Try
            ...
            frmUrinWorklist.LoadRecords()
            frmUrinWorklist.LoadRecordsCompleted()
...
#Region "HIS Integration Methods"
    ...
    Public Function getHIS_Test(ByVal accesion_no As String, or_no As String, ByVal cs_no As String)
        ...
        rs.Parameters.AddWithValue("@section", "Urinalysis")
    ...
    Public Sub UpdateResultiHOMIS()
        Try
            For x = 0 To GridView.RowCount - 1 Step 1
                Dim SQL As String = "UPDATE hurres SET " & GridView.GetRowCellValue(x, GridView.Columns("HISTestCode")) & " = '" & GridView.GetRowCellValue(x, GridView.Columns("Result")) & "'" _

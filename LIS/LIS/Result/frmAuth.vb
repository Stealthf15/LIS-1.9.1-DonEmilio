            ...
            If (reader.HasRows = True) Then
                If (reader("username") = Me.txtUsername.Text) Then
                    ...
                    ElseIf Section = "Fecalysis" Then
                        ...
                        End If
                    ElseIf Section = "ImmunoSero" Then
                        If Method = "Release" Then
                            frmImmunoNew.ReleaseResultNoPrint()
                        ElseIf Method = "PrintRelease" Then
                            frmImmunoNew.PrintReleaseResult()
                        ElseIf Method = "Verify" Then
                            frmImmunoNew.VerifyResult()
                        End If
                    ElseIf Section = "Molecular" Then
                        If Method = "Release" Then
                            frmAntigenNew.ReleaseResultNoPrint()
                        ElseIf Method = "PrintRelease" Then
                            frmAntigenNew.PrintReleaseResult()
                        ElseIf Method = "Verify" Then
                            frmAntigenNew.VerifyResult()
                        End If
                    End If

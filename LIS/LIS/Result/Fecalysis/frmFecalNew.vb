...
Public Class frmFecalNew
    ...
    Private Sub btnPreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPreview.Click
        frmFecalPrevious.patientID = txtPatientID.Text
        frmFecalPrevious.section = Section
        frmFecalPrevious.SubSection = SubSection
        frmFecalPrevious.Age = txtAge.Text
        frmFecalPrevious.Sex = cboSex.Text
        frmFecalPrevious.Classification = txtClass.Text
        frmFecalPrevious.ShowDialog()
    End Sub
...
#Region "Procedure for Release"
    ...
    Private Sub btnPrintNow_ItemClick(ByVal sender As Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnPrintNow.ItemClick
        Try
            ...
            Using myRDLCPrinter As New RDLCPrinterPrintNew(mainID, Section, SubSection, 1, My.Settings.DefaultPrinter)
                If My.Settings.SaveAsPDF Then
                    Dim byteViewer As Byte() = myRDLCPrinter.LocalReport.Render("PDF")
                    Dim saveFileDialog1 As New SaveFileDialog()
                    saveFileDialog1.Filter = "*PDF files (*.pdf)|*.pdf"
    ...
    Public Sub UpdateResultiHOMIS()
        Try
            For x = 0 To GridView.RowCount - 1 Step 1
                Dim SQL As String = "UPDATE hfecaly SET " & GridView.GetRowCellValue(x, GridView.Columns("HISTestCode")) & " = '" & GridView.GetRowCellValue(x, GridView.Columns("Result")) & "'" _

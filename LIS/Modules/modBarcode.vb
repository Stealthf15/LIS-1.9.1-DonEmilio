...
Module modBarcode
    ...
    Public Sub PrintBarcode(bc_Specimen As String, bc_sID As String, bc_pID As String, bc_pName As String, bc_BDate As String, bc_Gender As String, bc_Section As String, bc_SubSection As String, num_copies As Integer)
        If My.Settings.PrintBarcode Then
            ...
            PrintPreviewDialog.Document.PrinterSettings.Copies = num_copies
    ...
    Private Sub PrintDocument_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument.PrintPage
        ...
        BarcodeControl.Width = 712
        BarcodeControl.Height = 131

        Dim bm As New Bitmap(712, 131)
        ...
        e.Graphics.DrawString(BCAge, myFont, myBrush, 145, 5)
        ...
        e.Graphics.DrawString(BCpID, myFont, myBrush, 130, 15)
        ...
        ''e.Graphics.DrawString("→", FontArrow, myBrush, 170, 30)
        'e.Graphics.DrawImage(bm, 10, 15, 110, 55)
        'e.Graphics.DrawString("PID:" & BCpID, myFont, myBrush, 130, 15)
        'e.Graphics.DrawString("SID:" & BCsID, myFont, myBrush, 130, 25)
        ''e.Graphics.DrawString(BCRequest, myFont, myBrush, 10, 80)
        ''e.Graphics.DrawString(Now, myFont, myBrush, 10, 90)
    ...
    Private Function retrieveTest(SampleID As String, Section As String, SubSection As String) As String
        ...
        rs.CommandText = "SELECT DISTINCT `his_code` FROM `patient_order` WHERE `sample_id` = @sample_id AND `testtype` = @Section AND `sub_section` = @SubSection"
